...
function Mahasiswa(firstName, lastName, birth, nim, prodi, nilai) {
...
//Program mengulang dengan 'ngulang' sebagai kunci
while (ngulang == true) {
  ...
  switch(choice) {
    case '1':
      ...
      mahasiswa = new Mahasiswa(firstName, lastName, birth, nim, prodi);
    ...
    default :
      //berjalan jika input 'choice' tidak sesuai
