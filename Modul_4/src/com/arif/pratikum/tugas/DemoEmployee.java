package com.arif.pratikum.tugas;

public class DemoEmployee {
    public static void main(String[] args) {

        // Inisiasi objek SalariedEmployee dan mengisi nilai masing - masing parameter
        SalariedEmployee salaried = new SalariedEmployee("Uyung Amaik",
                "19104245",
                5300000);
        ...
        CommisionEmployee commision = new CommisionEmployee("Supiak Banun",
                "19105325",
                5300000,
                1000000,
                100);
        ...
        ProjectPlanner planner = new ProjectPlanner("Danang Priuk",
                "19104099",
                5000000,
                1000000,
                10);
